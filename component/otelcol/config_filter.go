...
type MatchProperties struct {
	...
	// This is an optional field.
	Attributes []*Attribute `river:"attributes,block,optional"`
	//TODO: Use pointers here or no?
	...
	// This is an optional field.
	Resources []*Attribute `river:"resources,block,optional"`
	...
	// This is an optional field.
	Libraries []*InstrumentationLibrary `river:"libraries,block,optional"`
...
// Return an empty slice if the input slice is empty.
func convertInstrumentationLibrariesSlice(attrs []*InstrumentationLibrary) []interface{} {
	attrArr := make([]interface{}, 0, len(attrs))
	for _, attr := range attrs {
		attrArr = append(attrArr, attr.Convert())
	}
...
// Make sure that when functions like this get called, there is a chick for nil?
...
type InstrumentationLibrary struct {
	...
	//TODO: Why was this version string a pointer?
}
